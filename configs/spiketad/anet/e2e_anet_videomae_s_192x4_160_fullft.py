...
dataset = dict(
    train=dict(
        ...
        pipeline=[
            dict(type="PrepareVideoInfo", format="avi", prefix="v_"), #mp4
...
model = dict(
    backbone=dict(
        ...
        custom=dict(
            pretrain="checkpoints/vit-small-p16_videomae-k400-pre_16x4x1_kinetics-400_my.pth",
...
post_processing = dict(
    ...
    external_cls=dict(
        ...
        path="./data/anet/classifiers/cuhk_val_simp_7.json",
        topk=2,
    ),
    save_dict=False,
)
