...
class AnchorFreeHead(nn.Module):
    ...
    def forward_test(self, feat_list, mask_list, **kwargs):
        ...
        for l, (feat, mask) in enumerate(zip(feat_list, mask_list)):
            ...
            # print("feat.shape:",feat.shape) #torch.Size([8, 512, 2304])
            # assert 1==2
            ...
            for i in range(self.num_convs):
                ...
                # print("i:",i)
                # print("cls_feat.shape:",cls_feat.shape) #torch.Size([8, 512, 2304])
                # print("reg_feat.shape:",reg_feat.shape) #torch.Size([8, 512, 2304])
                # assert 1==2
            
            # cls_feat = cls_feat.mean(0).unsqueeze(0) #thumos专用
            # reg_feat = reg_feat.mean(0).unsqueeze(0)

            # print("2cls_feat.shape:",feat.shape) #torch.Size([8, 512, 2304])
            # print("2reg_feat.shape:",feat.shape) #torch.Size([8, 512, 2304])
            # assert 1==2
